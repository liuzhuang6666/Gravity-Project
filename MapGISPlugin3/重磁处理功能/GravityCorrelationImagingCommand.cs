...
namespace MapGISPlugin3
{
    ...
    /// </summary>
    public class GravityCorrelationImagingCommand : ICommand
    {
        ...
        /// 功能的标题，会显示在按钮或菜单上
        /// </summary>
        public string Caption { get { return "重力相关成像"; } }
        ...
        /// </summary>
        public string Message { get { return "执行重力数据的互相关成像算法"; } }
        ...
        /// 鼠标悬停时显示的工具提示
        /// </summary>
        public string Tooltip { get { return "重力相关成像"; } }
        ...
        public void OnClick()
        {
            ...
            if (_hk != null)
            {
                // 创建我们之前修改好的窗体实例
                // 并将钩子 _hk 传递给窗体的构造函数
                Form_GravityCorrelationImaging form = new Form_GravityCorrelationImaging(_hk);
