...
{
    public partial class GravityFieldTransformForm : Form
    {
        ...
        public GravityFieldTransformForm(IApplication hook)
        {
            InitializeComponent();
            // 新增：初始化拖动和边框功能
            InitDragEvent();
        ...
        private void GravityFieldTransformForm_Load(object sender, EventArgs e)
        {
            // 移除这行有问题的代码
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (StreamReader sr = new StreamReader(fs, Encoding.Default))
            {
                ...
                if (line == "DSAA")
                {
                    ...
                    // ... (填充 buffer 的代码被移除)
                    // 重力窗口不调用ExecuteReduceToPoleAlgorithm
                    if (modeStr == "方向导数")
                    {
