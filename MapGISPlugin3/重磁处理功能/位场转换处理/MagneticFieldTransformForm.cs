...
{
    public partial class MagneticFieldTransformForm : Form
    {
        ...
        public MagneticFieldTransformForm(IApplication hook)
        {
            InitializeComponent();
            // 新增：初始化拖动和边框功能
            InitDragEvent();
        ...
        private void MagneticFieldTransformForm_Load(object sender, EventArgs e)
        {
            // 移除这行有问题的代码
