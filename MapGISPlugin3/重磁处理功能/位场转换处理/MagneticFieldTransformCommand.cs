// MagneticFieldTransformCommand.cs
using System;
...
{
    public class MagneticFieldTransformCommand : ICommand
    {
        // 成员变量，用于保存从OnCreate接收的hook
        private IApplication m_hook;
        #region ICommand 成员
        public Bitmap Bitmap { get { return null; } }
        public string Caption { get { return "磁法位场转换"; } }
        public string Category { get { return "重磁处理"; } } // 分类可以自定义
        public bool Checked { get { return false; } }
        public bool Enabled { get { return true; } }
        public string Message { get { return "执行磁法位场转换处理功能"; } }
        public string Name { get { return "MagneticFieldTransformCommand"; } } // 建议使用英文名
        public string Tooltip { get { return "磁法位场转换"; } }
        /// <summary>
        ...
        public void OnClick()
        {
            ...
            // 创建主窗体实例，并将钩子传递进去
            using (MagneticFieldTransformForm form = new MagneticFieldTransformForm(this.m_hook))
            {
