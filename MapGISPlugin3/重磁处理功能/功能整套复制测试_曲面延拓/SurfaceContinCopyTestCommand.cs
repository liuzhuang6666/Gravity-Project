...
namespace MapGISPlugin3
{
    ...
    /// 用于启动“曲面延拓”窗体的命令
    /// </summary>
    public class SurfaceContinCopyTestCommand : ICommand
    {
        ...
        public string Name { get { return "SurfaceContinCopyTestCommand"; } }
        ...
        public void OnClick()
        {
            ...
            {
                // 创建并显示新的窗体
                using (Form_SurfaceContinCopyTest continForm = new Form_SurfaceContinCopyTest(_hk))
                {
