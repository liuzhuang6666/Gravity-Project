...
{
    public partial class Form_SurfaceContinCopyTest : Form
    {
        ...
        public Form_SurfaceContinCopyTest(IApplication hook)
        {
            InitializeComponent();
            // 新增：初始化拖动和边框功能
            InitDragEvent();
        ...
        private void Form_SurfaceContinCopyTest_Load(object sender, EventArgs e)
        {
