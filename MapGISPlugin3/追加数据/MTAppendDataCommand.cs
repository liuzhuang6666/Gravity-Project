...
namespace MapGISPlugin3
{
    ...
    /// MT 追加观测数据命令
    /// </summary>
    public class MTAppendDataCommand : ICommand
    {
        ...
        public string Caption { get { return "MT 追加观测数据"; } }
        public string Category { get { return "地学数据处理"; } }
        public bool Checked { get { return false; } }
        public bool Enabled { get { return true; } }
        public string Message { get { return "向已有MT数据追加新的观测数据"; } }
        public string Name { get { return "MTAppendDataCommand"; } }
        public string Tooltip { get { return "追加 MT 观测数据"; } }
        ...
        public void OnClick()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("当前文档中没有地图，请先导入MT数据。", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }

                using (Form_MTAppendData appendForm = new Form_MTAppendData(_hk))
                {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"MTAppendDataCommand 异常: {ex}");
            }
        }
        ...
        {
            this._hk = hook;
            Console.WriteLine("MTAppendDataCommand 已创建。");
        }
