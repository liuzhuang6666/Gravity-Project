...
namespace MapGISPlugin3
{
    ...
    /// CSAMT 追加观测数据命令
    /// </summary>
    public class CSAMTAppendDataCommand : ICommand
    {
        ...
        public string Caption { get { return "CSAMT 追加观测数据"; } }
        public string Category { get { return "地学数据处理"; } }
        public bool Checked { get { return false; } }
        public bool Enabled { get { return true; } }
        public string Message { get { return "向已有CSAMT数据追加新的观测数据"; } }
        public string Name { get { return "CSAMTAppendDataCommand"; } }
        public string Tooltip { get { return "追加 CSAMT 观测数据"; } }
        ...
        public void OnClick()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("当前文档中没有地图，请先导入CSAMT数据。", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }

                using (Form_CSAMTAppendData appendForm = new Form_CSAMTAppendData(_hk))
                {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"CSAMTAppendDataCommand 异常: {ex}");
            }
        }
        ...
        {
            this._hk = hook;
            Console.WriteLine("CSAMTAppendDataCommand 已创建。");
        }
